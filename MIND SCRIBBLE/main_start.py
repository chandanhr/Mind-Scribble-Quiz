...
def start_main_page():
    def start_game(args):
        main_window.destroy()
        if args == 1:
            from Options import mce
            mce.main()
        elif args == 2:
            from Options import ise
            ise.main()
        elif args == 3:
            from Options import covid
            covid.main()
        elif args == 4:
            from Options import brain
            brain.main()
        elif args == 5:
            from Options import series
            series.main()
        elif args == 6:
            from Options import sports
            sports.main()
        elif args == 7:
            from Options import lockdown
            lockdown.main()
    ...
    main_window.title("Mind Scribble --> Grow your knowledge with Quizee")
    main_window.configure(background="#e6fff5")
    main_window.iconbitmap(r'quizee_logo1.ico')

    img0 = PhotoImage(file="quizee_logo2.png")
